...
init(){
        ...
        for(const key in this.menuInventory){
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Some quick example text to build on card title and make up the bulk of the card's content.</p>
        ...
        for(const key in this.menuInventory){
            ...
            buttons.forEach(button => {
                button.addEventListener('click', ()=>{
                    // if the id of the data attribute mathces the item.id
    ...
    checkout(){
        ...
        const shipping = 6;
        // console.log(mainPage.classList, checkoutPage.classList, checkout)
                ...
                if(item.qty > 0){
                    ...
                    <td id="checkoutImg">
                        ...
                        <div class="product-desc">
                            ...
                            <p>This is a nice description of this item. YUUMM!</p>
                        </div>
                    </td>
                    <td>
